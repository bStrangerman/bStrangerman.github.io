				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							...
							<h1><span>Brandon Cooper Haberman</span></h1>
							<h3><span>Industrial Engineer</span></h3>
							<p>
	...
	<div id="fh5co-about" class="animate-box">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<ul class="info">
						<li><span class="first-block">Full Name:</span><span class="second-block">Brandon Cooper Haberman</span></li>
						<li><span class="first-block">Phone:</span><span class="second-block">+1 (747) 800 1468</span></li>
						<li><span class="first-block">Email:</span><span class="second-block">brandon@kd6bch.com</span></li>
						<li><span class="first-block">Website:</span><span class="second-block">brandonhaberman.com</span></li>
				...
				<div class="col-md-12 col-md-offset-0">
					<ul class="timeline">
						...
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Student Engineer Intern</h3>
									<span class="company">los Angeles Department of Water and Power - 2018</span>
								</div>
								<div class="timeline-body">
									<p>Developed solutions to reduce a backlog in providing new customers with power service.</p>
								</div>
							</div>
						</li>
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Industrial Engineering BSIE</h3>
									<span class="company">Purdue University - 2016 - 2020</span>
								</div>
								<div class="timeline-body">
									<p>.</p>
								</div>
						...
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Certificate in Entrepeaneurship and Innovation</h3>
									<span class="company">Purdue University - 2016 - 2020</span>
								</div>
								<div class="timeline-body">
									<p>Designed business models, financial breakdowns, and investor pitches to simulate the development of a startup company.</p>
								</div>
							</div>
						</li>
						<!-- <li class="timeline-inverted animate-box">
					...
					<div class="col-md-4 text-center">
						<div class="feature-left">
							...
							<div class="feature-copy">
								...
								<p>blah blah web php sql blah blah</p>
							</div>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="row row-pb-md">
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="65"><span><strong>HTML5</strong>65%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="25"><span><strong>CSS3</strong>25%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
				...
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="50"><span><strong>R</strong>50%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="45"><span><strong>C</strong>45%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="50"><span><strong>MatLab</strong>50%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="85"><span><strong>Excel</strong>85%</span></div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
			...
			<div class="row">
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#" class="work" style="background-image: url(images/portfolio-1.jpg);">
						<div class="desc">
							<h3>@Capacity</h3>
							<span>Computing in IE Course Project</span>
						</div>
					</a>
				</div>
				<div class="col-md-3 text-center col-padding animate-box">
	...
	<div id="fh5co-started" class="fh5co-bg-dark">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Hire Me!</h2>
					<p>I am seeking an Internship that I can apply my technological exprience to improve the analytics and/ or operations of a company.</p>
